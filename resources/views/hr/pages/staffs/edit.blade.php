                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                ...
                                <select name="faculty" class="@error('faculty') is-invalid @enderror form-control" id="faculty">
                                    <option @if($staff->technoscience == "TechnoScience") selected @endif value="TechnoScience">TechnoScience</option>
                                    <option @if($staff->technoscience == "Health Science") selected @endif value="Health Science">Health Sciences</option>
                                    <option @if($staff->technoscience == "Education") selected @endif value="Education">Education</option>
                                    <option @if($staff->technoscience == "Management Science") selected @endif value="Management Science">Management Science</option>
                                </select>
                                @error('faculty')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
