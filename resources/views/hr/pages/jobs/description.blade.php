    ...
    <div class="row">
      <div class="col-md-4">
        <div class="list-group shadow">
          ...
          <a href="{{ route('hr.jobs') }}" class="list-group-item list-group-item-action border-custom active"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Jobs </a>
        </div>
      </div>
      <div class="col-md-8">
        <!-- Website Overview -->
