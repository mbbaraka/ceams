            ...
            <div class="card">
              ...
              <div class="card-body border-custom p-0">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('publications.index') }}" class="list-group-item list-group-item-action {{ Request::is('publications') ? 'active' : '' }}"><span class="fa fa-newspaper-o" aria-hidden="true"></span> Publications <span class="badge badge-custom float-right">{{$Publication->count()}}</span></a>
                    ...
                    <a href="{{ route('lectures.index') }}" class="list-group-item list-group-item-action {{ Request::is('lectures') ? 'active' : '' }}"><span class="fas fa-open-book" aria-hidden="true"></span> Public Lectures/Papers Presented <span class="badge badge-custom float-right">{{$PublicLecture->count()}}</span></a>
                    <a href="{{ route('researchactivities.index') }}" class="list-group-item list-group-item-action {{ Request::is('researchactivities') ? 'active' : '' }}"><span class="fab fa-researchgate" aria-hidden="true"></span> Research Activities <span class="badge badge-custom float-right">{{$ResearchActivity->count()}}</span></a>
